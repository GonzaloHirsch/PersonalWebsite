...
export default {
  name: 'Button',
  props: ['text', 'aria', 'target', 'href', 'extraClass', 'format']
}
</script>
...
.button-white {
    @apply border-2 border-brand_primary_light text-brand_primary_light bg-transparent;
}

.button-white:hover {
    @apply bg-brand_primary_light text-white;
}
